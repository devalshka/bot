...
local Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "مايكل")
...
local list = {
            ...
            "حياتك بكلمة ؟",
            "عندك مليون ريال بس ماتكدر تشتري الا شيء  يبدأ بأول حرف من اسمك. وش بتشتري ؟",
